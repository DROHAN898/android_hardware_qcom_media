...
libmm-vidc-inc      += $(TOP)/hardware/qcom/media/$(TARGET_BOARD_PLATFORM)/mm-core/inc
libmm-vidc-inc      += $(TARGET_OUT_HEADERS)/qcom/display
libmm-vidc-inc      += $(TOP)/hardware/qcom/media/$(TARGET_BOARD_PLATFORM)/libc2dcolorconvert
